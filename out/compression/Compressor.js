...
var Compressor = /** @class */ (function () {
    ...
    Compressor.prototype.compressDataStore = function (dataStore, encoderEnums) {
        ...
        var encoders = encoderEnums
            .map(function (encoderEnum) { var _a; return (_a = ENCODERS[encoderEnum]) === null || _a === void 0 ? void 0 : _a.call(ENCODERS); })
    ...
    Compressor.prototype.expandDataStore = function (arrayBuffer) {
        ...
        do {
            ...
            var decoder = (_a = ENCODERS[encoderEnum]) === null || _a === void 0 ? void 0 : _a.call(ENCODERS);
            if (decoder) {
