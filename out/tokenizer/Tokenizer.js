...
var Tokenizer = /** @class */ (function () {
    ...
    Tokenizer.prototype.tokenizeHelper = function (item, registry, counter, file) {
        ...
        if (type === "array") {
            ...
            var hash = (0, md5_1["default"])(hashes.join(","));
            ...
            var hash = (0, md5_1["default"])("".concat(keysToken.hash, "|").concat(valuesToken.hash));
            ...
            var hash = (0, md5_1["default"])("".concat(chunksToken.hash, "-").concat(separatorsToken.hash));
            return this.registerToken(hash, item, registry, counter, file, [chunksToken.hash, separatorsToken.hash]);
        }
        else {
            return this.registerToken((0, md5_1["default"])(JSON.stringify(item)), item, registry, counter, file);
        }
    };
    return Tokenizer;
}());
